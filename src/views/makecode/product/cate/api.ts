...
enum Api {
    getList = '/makecode/productcate/get_list',
    getCate = '/makecode/productcate/get_cate',
    save = '/makecode/productcate/save',
    upStatus = '/makecode/productcate/upStatus',
    del = '/makecode/productcate/del',
}
