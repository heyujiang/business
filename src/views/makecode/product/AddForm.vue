                    ...
                    <a-col :span="12">
                      <a-form-item field="cid" label="选择分类" validate-trigger="input" >
                        <a-select v-model="formData.cid" :options="cateList" placeholder="请选择分类" />
										...
										<a-col :span="12">
											<a-form-item field="title" label="标题1" :rules="[{required:true,message:'请填写标题1'}]" >
													<a-input v-model="formData.title" placeholder="请填标题1" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="price" label="价格"  >
													<a-input-number v-model="formData.price" placeholder="请填价格" />
											</a-form-item>
										</a-col>
										<a-col :span="12">
											<a-form-item field="num" label="库存" :rules="[{required:true,message:'请填写库存'}]" >
													<a-input-number v-model="formData.num" placeholder="请填库存" />
											</a-form-item>
										</a-col>
                    </a-row>
                </div>
